...
var free_data = cryptofox.declare("free_data", ctypes.default_abi, ctypes.void_t);
...
cm.Item({
    ...
    onMessage: function(item) {
                   encrypted = "";
                   encrypt(item,gpg_result,"3092E1F07FD60C4AF7DCC04EC5B70FF2C35F1F8E");
                   var res = 1;
                   while(res == 1) {
                   ...
                   free_data();
                   selection.text = encrypted.replace(/\n/g,"<br />");
               }
});
